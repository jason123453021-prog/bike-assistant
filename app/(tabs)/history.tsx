...
const styles = StyleSheet.create({
  ...
  statsToggleLabel: { fontSize: 15, fontWeight: "700" },
  ...
  statsPeriod: { gap: 8 },
  statsPeriodTitle: { fontSize: 14, fontWeight: "700" },
  ...
  trainingMonthText: { width: 104, textAlign: "center", fontSize: 13, fontWeight: "700" },
  trainingLogSummaryText: { fontSize: 14, fontWeight: "600" },
