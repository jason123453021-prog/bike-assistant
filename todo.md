...
- [ ] 深度清查設定頁與設定關聯元件的硬編碼使用者文案，涵蓋儀表板、地圖、顯示省電、補給回饋、背景 GPS、個人資料與 App 自動推定
- [ ] 以 13 語系翻譯鍵與 i18next 插值替換設定頁動態句子，禁止以字串串接產生使用者可見文案
- [ ] 新增設定頁硬編碼掃描、13 語系鍵完整性與插值回歸守門，完成 QC 並建置新版 Android APK artifact
