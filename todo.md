...
- [ ] 提升地圖右上角自由定位模式按鈕的實心背景、陰影層次與非高亮圖示對比，確保複雜地圖與戶外光線下可辨識
- [ ] 盤點並補齊儀表板、進階儀表板、設定頁與路線分析的 i18n 字串，讓 12 種支援語系可即時完整切換
- [ ] 新增硬編碼字串掃描與 12 語系核心畫面回歸守門，完成完整 QC 與最新版 Android APK artifact
